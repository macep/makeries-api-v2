<div class="row">
    <div class="col-md-3">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/service/index">
              <div class="box-body">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="name" value="<?=$filter['name']?>" class="form-control" placeholder="serviceername">
                </div>
              </div>
              <!-- /.box-body -->
          ...
          <div class="box-body">
            ...
            <table class="table table-hover" width="100%">
                ...
                <tr>
                    ...
                    <td><a href='/service/edit/?id=<?=$service->id?>'><?=$service->name?></a></td>
                    <td><a href='/service/delete/?id=<?=$service->id?>' class="fa fa-remove danger" onclick="return confirm('Are you sure?');"></a></td>
                </tr>
                <?php endforeach;?>
            </table>  
          </div>
