<div class="row">
    <div class="col-md-3">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/material/index">
              <div class="box-body">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="name" value="<?=$filter['name']?>" class="form-control" placeholder="material name">
                </div>
              </div>
              <!-- /.box-body -->
            ...
            <div class="box-body" style="display: none;">
                <form method="post" action="/material/save/" id="materialSave" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" id="newBusiness TypeName" placeholder="new material name">
                            </div>
                        </div>
                        <div class="box-footer">
          ...
          <div class="box-body">
            ...
            <table class="table table-hover" width="100%">
                ...
                <tr>
                    ...
                    <td><a href='/material/edit/?id=<?=$material->id?>'><?=$material->name?></a></td>
                    <td><a href='/material/delete/?id=<?=$material->id?>' class="fa fa-remove danger" onclick="return confirm('Are you sure?');"></a></td>
                </tr>
                <?php endforeach;?>
            </table>  
          </div>
